...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->num_rows > 0) {
        ...
        header('Location: inicio.php?error=El+videojuego+ya+existe+en+la+base+de+datos.');
    } else {
        ...
        if ($stmt->execute()) {
            header('Location: inicio.php?mensaje=El+videojuego+se+ha+registrado+exitosamente.');
        } else {
